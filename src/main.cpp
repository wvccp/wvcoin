...
const string strMessageMagic = "wvccp Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // wvccp: 0.35 days
static const int64 nTargetSpacing = 15; // wvccp: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal wvccp miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "wvccp", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x76436e2a6cfc6d83c9a49996d7d978995f57b2b5d4ec8fa902059e87f79b68d4");
    }
